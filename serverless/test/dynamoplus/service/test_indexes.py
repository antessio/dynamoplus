...
class TestIndexService(unittest.TestCase):
    ...
    def test_findDocument(self, mock_repository,mock_find):
        ...
        data =[
            Model(documentTypeConfiguration,{"pk": "example#1","sk":"example#attribute1", "data":"value1"}),
            Model(documentTypeConfiguration,{"pk": "example#2","sk":"example#attribute1", "data":"value1"}),
            Model(documentTypeConfiguration,{"pk": "example#3","sk":"example#attribute1", "data":"value1"})
            ]
