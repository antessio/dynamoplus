...
from dynamoplus.models.query.conditions import And, Range, Eq, get_range_predicate,is_valid, get_field_names_in_order
...
class TestConditions(unittest.TestCase):
    ...
    def test_and_to_data_nested(self):
        ...
        self.assertEqual("and(eq(field1)__range(field2)__and(eq(fieldA)__eq(fieldB)__eq(fieldC)))", and_condition.to_string())
    ...
    def test_get_conditions_in_order(self):
        ...
        nested = And([Eq("fieldA", "valueA"), Eq("fieldB", "valueB"), And([Eq("fieldC", "valueC"),Eq("fieldD", "valueD")])])
        field_names = get_field_names_in_order(nested)
